...
REDACTED\\
REDACTED\\
Prof. Dr. Christian R. Proa\~{n}o and Maybrit W\"achter, MSc\\[0.8cm]

Matriculation Number: REDACTED\\
Address: REDACTED\\
Place of Birth: Ha\ss{}furt, Germany\\[1.5cm]
...
if (!fs::file_exists(fevd_path)) {
  ...
  ggplot2::ggplot(FE, ggplot2::aes(x=horizon, y=share, fill=group)) +
    ggplot2::geom_area(position="stack", alpha=.95) +
    ggplot2::facet_grid(regime ~ proxy) +
    ggplot2::scale_y_continuous(labels = scales::percent_format(accuracy = 1),
                                limits = c(0,1), expand = ggplot2::expansion(mult = c(0, .02))) +
    ggplot2::scale_x_continuous(breaks = c(0,6,12,18,24,30,36)) +
 ggplot2::labs(x = "Horizon (months)", y = "Share of forecast variance",
